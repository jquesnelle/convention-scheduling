...
\end{flalign}
\end{quote}
The first constraint (a) of ECTTO merely enforces all availability and suitability sets. We implicitly enforce this in our model by considering only the variables in $\mathcal F$. As such, no specific constraints are needed in our model.
