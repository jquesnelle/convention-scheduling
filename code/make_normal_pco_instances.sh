...
do
	...
	do
		...
		python main.py --setup-db-2013normal schedule2013.html.db 100 14 1000 0 $s
		python main.py --generate-model-pco schedule2013.html.db
		mv schedule2013.html.db.lp ../instances/2013_normal_pco_decreasing_sigma/instance$s-$i.lp
	done
	s=$(echo "$s - 0.01"|bc)
done
